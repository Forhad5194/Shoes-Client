...
const Banner = () => {
    ...
    const sliders = [{ img: "https://i.ibb.co/kSbPDcy/1.jpg", title: "Step into Style", des: "Discover Our Latest Shoe Collections Today." }, { img: "https://i.ibb.co/NrTNc5p/2.jpg", title: "Elevate Your Look", des: "Explore Trendy Footwear for Every Occasion." }, { img: "https://i.ibb.co/VMWf0C3/3.jpg", title: "Comfort Meets Fashion", des: "Find the Perfect Pair for Your Feet." }, { img: "https://i.ibb.co/4TmB9zZ/4.jpg", title: "Walk with Confidence", des: "Unveil Our Exclusive Shoe Selections Now." },];
    ...
    return (
        <div >
            <div className="w-full rounded-2xl text-2xl font-medium mt-5 h-60 sm:h-96 md:h-[540px] flex flex-col xl:flex-row items-center justify-center gap-5 lg:gap-10 relative bg-cover before:absolute before:bg-black/50 before:inset-0 transform duration-1000 ease-linear z-50 overflow-hidden"
